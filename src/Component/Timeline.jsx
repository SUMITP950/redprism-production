                ...
                >
                  <li class="nav-item">
                    <a
                      ...
                      aria-selected="true"
                    >
                      <i class="feather-edit"></i> Share an update
                    </a>
                  </li>
                  <li class="nav-item">
                    <a
                      ...
                      aria-selected="false"
                    >
                      <i class="feather-image"></i> Upload a photo
                    </a>
                  </li>
                  <li class="nav-item">
                    <a
                ...
                <div class="border-top p-3 d-flex align-items-center">
                  <div class="mr-auto">
                    <a href="#" class="text-link small">
                      <i class="feather-map-pin"></i> Add Location
                    </a>
                  </div>
              ...
              <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                ...
                <div class="p-3 border-bottom osahan-post-footer">
                  <a href="#" class="mr-3 text-secondary">
                    <i class="feather-heart text-danger"></i> 16
                  </a>
                  <a href="#" class="mr-3 text-secondary">
              ...
              <div class="box mb-3 shadow-sm border rounded bg-white osahan-post">
                ...
                <div class="p-3 border-bottom osahan-post-body">
                  <p>
                    ...
                    exercitation ullamco <a href="#">laboris consequat.</a>
                  </p>
                  <img
                    src="img/post1.png"
                    class="img-fluid"
                ...
                <div class="p-3 d-flex align-items-top border-bottom osahan-post-comment">
                  ...
                  <div class="font-weight-bold">
                    <div class="text-truncate">
                      {" "}
                      James Spiegel <span class="float-right small">2 min</span>
                    </div>
                    <div class="small text-gray-500">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
              <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                ...
                <div class="overflow-hidden border-top">
                  <a class="font-weight-bold p-3 d-block" href="profile.html">
                    {" "}
                    View my profile{" "}
                  </a>
                </div>
              ...
              <div class="box shadow-sm border rounded bg-white mb-3">
                <div class="box-title border-bottom p-3 d-flex align-items-center">
                  ...
                  <a class="ml-auto" href="#">
                    See All <i class="feather-chevron-right"></i>
                  </a>
                </div>
                <div class="box-body p-3">
