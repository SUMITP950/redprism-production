              ...
              <div class="d-flex align-items-center py-3">
                <div class="profile-left">
                  ...
                  <p class="mb-0 text-muted">
                    {" "}
                    Internet | Mountain View, CA | 14,128,005 followers
                  </p>
                </div>
                ...
                >
                  <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                      ...
                      <p class="mb-0">
                        Since our founding in 1998, Google has grown by leaps
                        and bounds. From offering search in a single language we
                        now offer dozens of products and services—including
                        various forms of advertising and web applications for
                        all kinds of tasks—in scores of languages. And starting
                        from two computer science students in a university dorm
                        room, we now have thousands of employees and offices
                        around the world. A lot has changed since the first
                        Google search engine appeared. But some things haven’t
                        changed: our dedication to our users and our belief in
                      ...
                      <table class="table table-borderless mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="p-3">
                              search, ads, mobile, android, online video, apps,
                              machine learning, virtual reality, cloud,
                              hardware, artificial intelligence, youtube, and
                              software
                            </td>
                          </tr>
                        </tbody>
                          ...
                          <div class="card overflow-hidden">
                            ...
                            <div class="card-body">
                              ...
                              <a href="#" class="text-link font-weight-bold">
                                <i class="feather-external-link"></i> Get
                                Directions
                              </a>
                            </div>
                          </div>
                ...
                >
                  <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                    ...
                    <div class="p-3 border-bottom osahan-post-body">
                      <p class="mb-0">
                        Tmpo incididunt ut labore et dolore magna aliqua. Ut
                    ...
                    <div class="p-3 border-bottom osahan-post-footer">
                      ...
                      <a href="#" class="mr-3 text-secondary">
                        <i class="feather-message-square"></i> 8
                      </a>
                      <a href="#" class="mr-3 text-secondary">
                        <i class="feather-share-2"></i> 2
                      </a>
                    </div>
                    <div class="p-3">
                      <button
                    ...
                    <div class="p-3 d-flex align-items-top border-bottom osahan-post-comment">
                      ...
                      <div class="font-weight-bold">
                        <div class="text-truncate">
                          {" "}
                          James Spiegel{" "}
                          <span class="float-right small">2 min</span>
                        </div>
                        <div class="small text-gray-500">
                          ...
                          <div class="border job-item mb-3">
                            ...
                            <div class="p-3 job-item-footer">
                              <small class="text-gray-500">
                                <i class="feather-clock"></i> Posted 3 Days ago
                              </small>
                            </div>
                          </div>
                        </a>
                          ...
                          <div class="media">
                            ...
                            <div class="media-body">
                              ...
                              <div class="reviews-members-body">
                                <p>
                                  {" "}
                                  reacthe last order. Even though they had Chefs
                                  in their open kitchen they weren’t flexible to
                                  dish out few more items. Anyway the food was
                                  super specially their stone dessert.
                                </p>
                              </div>
                              <div class="reviews-members-footer d-flex align-items-center">
                                <a
                                  ...
                                  href="#"
                                >
                                  <i class="feather-thumbs-up"></i> 123
                                </a>{" "}
                                <a
                                  class="total-like btn btn-outline-info btn-sm"
                                  href="#"
                                >
                                  <i class="feather-thumbs-down"></i> 02
                                </a>
                                <span
                                  dir="rtl"
                                  class="total-like-user-main ml-2"
                                >
                                  <div class="overlap-rounded-circle">
                                    <img
                                      class="rounded-circle shadow-sm"
                        ...
                        <div class="reviews-members">
                          <div class="media">
                            ...
                            <div class="media-body">
                              ...
                              <div class="reviews-members-body">
                                <p>
                                  Was here impromptu in their first week,
                                  reacthe last order. Even though they had Chefs
                                  in their open kitchen they weren’t flexible to
                                  dish out few more items.
                                </p>
                              </div>
                              <div class="reviews-members-footer d-flex align-items-center">
                                <a
              ...
              <div class="box shadow-sm border rounded bg-white mb-3">
                ...
                <div class="box-body p-3">
                  <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                    <div class="dropdown-list-image mr-3">
                      <img class="rounded-circle" src="img/l1.png" />
                    </div>
                    <div class="font-weight-bold mr-2">
                      <div class="text-truncate">Amazon</div>
                      <div class="small text-gray-500">Internet</div>
                    </div>
                    <span class="ml-auto">
                      <button
                        type="button"
                  ...
                  <div class="d-flex align-items-center osahan-post-header people-list">
                    ...
                    <div class="font-weight-bold mr-2">
                      ...
                      <div class="small text-gray-500">Entertainment</div>
                    </div>
                    <span class="ml-auto">
                      <button
                        type="button"
